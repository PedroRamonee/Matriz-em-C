...
/* Uma matriz é denominada de Matriz Identidade se ela
for uma matriz quadrada especial cujos elementos diagonais principais são iguais a 1 e os demais
elementos são 0, como a seguir:
